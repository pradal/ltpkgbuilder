...
def test_user_permission():
    ...
    with mock.patch('ltpkgbuilder.option_tools.input', return_value='y'):
        assert get_user_permission('action')
...
def test_ask_arg_do_not_prompt_user_if_value_in_extra():
    with mock.patch('ltpkgbuilder.option_tools.input', return_value='useless'):
...
def test_ask_arg_user_bypass_default():
    with mock.patch('ltpkgbuilder.option_tools.input', return_value='myvalue'):
